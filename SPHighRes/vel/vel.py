...
from SPHighRes.core.database.database import save_to_sqlite,load_from_sqlite
...
class VelModel:
    ...
    def get_perturbation_model(self, output, n_perturbations=1000, p_mean=0, p_std_dev=0.05,
        ...
        for i in tqdm(range(n_perturbations), "Perturbations"):
            ...
            save_to_sqlite(data, output, table_name=f"model_{i}")
...
class VelPerturbationModel:
    ...
    def __init__(self, db_path, models=None) -> None:
        ...
        data = load_from_sqlite(db_path, models)
        self.models = models
        self.data = data
