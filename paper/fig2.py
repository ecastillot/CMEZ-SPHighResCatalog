...
from SPHighRes.core.enverus.enverus import well_fig
...
output_folder_mean = os.path.join(data_path,"vp","regions")
output_fig = os.path.join(os.path.dirname(__file__),"fig2.png")
