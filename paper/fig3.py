...
output  = os.path.join(data_path,"earthquakes","HighRes","cmez.csv")
output_path = os.path.join(os.path.dirname(__file__),"fig3.png")

# to filter only cmez events
# events_path = os.path.join(data_path,"eaerthquakes","HighRes","origin.csv")
# events = get_texnet_high_resolution_catalog(evencxnet")
